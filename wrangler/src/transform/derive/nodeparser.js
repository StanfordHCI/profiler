module.exports = (function(){
  /* Generated by PEG.js 0.6.1 (http:
    ...
    parse: function(input, startRule) {
      ...
      function parse_additive() {
        ...
        var result7 = result8 !== null
          ? (function(left, right) { return dw.derive.add([left, right]); })(result8[0], result8[2])
          : null;
        if (result7 !== null) {
          var result0 = result7;
        } else {
          ...
          var result2 = result3 !== null
            ? (function(left, right) { return dw.derive.subtract([left, right]); })(result3[0], result3[2])
            : null;
          if (result2 !== null) {
            var result0 = result2;
          } else {
      ...
      function parse_multiplicative() {
        ...
        var result11 = result12 !== null
          ? (function(left, right) { return dw.derive.multiply([left, right]); })(result12[0], result12[2])
          : null;
        if (result11 !== null) {
          ...
          var result6 = result7 !== null
            ? (function(left, right) { return dw.derive.divide([left, right]); })(result7[0], result7[2])
            : null;
          if (result6 !== null) {
            var result0 = result6;
          } else {
